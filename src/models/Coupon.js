...
const couponSchema = new mongoose.Schema(
    {
        ...
        startDate: { type: Date },
        endDate: { type: Date },
        daysOfWeek: [{ type: Number }], // Chỉ áp dụng vào ngày trong tuần (0=CN, 1=T2,...,6=T7)
        ...
        // ===== Cho luồng đổi điểm (tùy chọn, nên có) =====
        redeemCost: { type: Number },                    // số điểm cần để đổi
        redeemStock: { type: Number },                   // tổng số voucher có thể “đổi”
        redeemedCount: { type: Number, default: 0 },     // đã đổi bao nhiêu voucher
        redeemTtlDays: { type: Number },                 // TTL sau khi đổi
    },
    { timestamps: true }
);
